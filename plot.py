...
with open("result_plot\\trajectory.pkl","rb") as handle:
    trajectory = pickle.load(handle)

plot_range = slice(100, len(trajectory["steps"]))
...
ax[2].plot(trajectory["steps"][plot_range], trajectory["K"][plot_range])
